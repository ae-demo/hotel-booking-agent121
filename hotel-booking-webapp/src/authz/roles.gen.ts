...
export const SCOPES: readonly Scope[] = ["bookings:cancel", "bookings:create", "bookings:read", "hotels:search"];

/** Every role a person can hold, sorted. Service-kind roles are not here. */
export const ROLES: readonly Role[] = ["Traveler"];
...
export const ROLE_GRANTS: Record<Role, readonly Scope[]> = {
  "Traveler": ["bookings:cancel", "bookings:create", "bookings:read", "hotels:search"],
};
